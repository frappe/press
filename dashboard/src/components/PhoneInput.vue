	...
	<div class="space-y-1.5">
		...
		<div class="flex">
			<Popover class="relative" placement="bottom-start">
				<template #target="{ togglePopover }">
					<button
						type="button"
						@click="togglePopover"
						class="flex h-7 items-center gap-1 rounded-l border border-r-0 border-gray-100 bg-surface-gray-1 px-2 text-sm text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400"
					>
			...
			<input
				...
				class="h-7 w-full rounded-r border border-gray-100 bg-surface-gray-1 px-2 text-base text-gray-800 placeholder-gray-500 focus:border-gray-500 focus:bg-surface-white focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-gray-400"
				@input="emitValue"
			/>
		</div>
	</div>
