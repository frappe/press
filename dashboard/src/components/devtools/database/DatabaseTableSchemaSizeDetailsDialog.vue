					...
					},
					{
						...
						component: ({ row }) => {
							return h(
								...
								{
									class:
										'inline-flex items-center justify-center gap-2 transition-colors focus:outline-none text-ink-gray-8 bg-surface-gray-1 hover:bg-gray-200 active:bg-surface-gray-4 focus-visible:ring focus-visible:ring-gray-400 h-7 text-base px-2 rounded',
									onClick: (_) => {
