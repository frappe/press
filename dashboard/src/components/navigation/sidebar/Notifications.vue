		...
		<template #body="{ togglePopover }">
			...
			>
				...
				>
                  ...
                  : unreadSupportNotificationsCount.data }}</Badge
							>
						</button>
					</template>
				</Tabs>
              ...
              dark:bg-surface-gray-1"
							:class="[iconCss[x.type].bg || 'bg-surface-gray-1']"
						>
							<span
								v-if="x.read == 0"
