				...
				<template #target="{ togglePopover }">
					...
					>
						<ComboboxInput
							...
							class="focus:ring-outline-gray-3 h-full w-full rounded border border-gray-100 bg-surface-gray-1 bg-transparent pl-2 pr-5 text-base text-ink-gray-8 placeholder-gray-500 transition-colors focus:border-gray-500 focus:bg-surface-white focus:shadow-sm focus:ring-0 focus-visible:ring-2 focus-visible:ring-gray-400"
						/>
					</div>
				</template>
