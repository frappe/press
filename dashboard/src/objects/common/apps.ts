...
const siteAppListOptions: Partial<TabList> = {
	...
	banner({ documentResource: site }) {
		const bannerTitle =
			'Your site is currently on a shared bench. Upgrade plan to install custom apps, enable server scripts and <a href="https://frappecloud.com/shared-hosting#benches" target="_blank">more</a>.';
