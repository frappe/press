											...
											h(
												...
												},
												{
													default: () => {
														return h('pre', {
															class:
																'whitespace-pre-wrap text-sm rounded border-2 p-3 border-gray-200 bg-surface-gray-1',
						...
						function confirmDownload(backup, file) {
							confirmDialog({
								...
								message: `You will be downloading the ${getFileName(
									...
									!backup.offsite
										? '<br><br><div class="p-2 bg-surface-gray-1 rounded border-gray-200">You have to be logged in as a <b>System Manager</b> <em>in your site</em> to download the backup.<div>'
										: ''
								}`,
								onSuccess({ hide }) {
