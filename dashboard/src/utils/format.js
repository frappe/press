...
// ECharts renders whatever a tooltip formatter returns as HTML, so anything
// that came off a site — a request path, a job method — has to be escaped
// before it goes into that string.
const HTML_ESCAPES = {
	'&': '&amp;',
	'<': '&lt;',
	'>': '&gt;',
