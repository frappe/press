<template>
	<div class="p-5">
		<div class="flex items-center space-x-2">
			...
			<h2 class="text-xl-medium text-ink-gray-9">{{ logName }}</h2>
		...
		<div
			class="mt-5 flex rounded bg-surface-gray-10 dark:bg-surface-gray-1 p-4 text-sm text-ink-gray-2 dark:text-ink-gray-8"
		>
