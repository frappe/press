	...
	<div class="min-h-screen bg-gray-50">
		<LoginBox>
			...
			<div class="mt-8" v-if="$resources.subscription.data">
				<div>
					<button
						class="flex w-full items-center justify-between rounded-sm bg-surface-gray-1 p-2 hover:bg-surface-gray-3"
						@click="currentStep = 1"
					>
				...
				<div class="mt-2" v-if="currentStep == 2">
					<div
						class="rounded-sm bg-surface-gray-1 p-2 text-sm font-medium text-ink-gray-7"
					>
