<template>
	<div>
		...
		<div class="mx-5">
			<!-- Filters Section -->
			<div class="pt-[20px]">
				<div class="bg-surface-base rounded-lg shadow p-4 mb-6">
			...
			<div
				...
				class="bg-surface-base rounded-lg shadow p-4 mb-6"
			>
				<h2 class="text-xl mb-4">Fetched Transactions</h2>
			...
			>
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
					<div class="bg-surface-gray-1 p-3 rounded">
						<div class="text-sm text-ink-gray-5">Total Amount</div>
					...
					<div class="bg-surface-gray-1 p-3 rounded">
						<div class="text-sm text-ink-gray-5">Net Amount</div>
						<div class="text-3xl-semibold">
