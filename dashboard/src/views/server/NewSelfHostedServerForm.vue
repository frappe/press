<template>
	<div>
		...
		<div class="mt-6 flex flex-col gap-4">
			...
			<Input class="z-10 w-full rounded-r-none" :value="publicIP" @change="$emit('update:publicIP', $event)"
				type="text" />
			<p class="text-base text-black-900">Private IP of the Server</p>
			<Input class="z-10 w-full rounded-r-none" :value="privateIP" @change="$emit('update:privateIP', $event)"
				type="text" />
			<div class="mt-4">
