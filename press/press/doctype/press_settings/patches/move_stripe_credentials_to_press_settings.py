...
def execute():
	...
	publishable_key = frappe.db.get_value("Stripe Settings", stripe_account, "publishable_key")
	...
	set_encrypted_password("Press Settings", "Press Settings", secret_key, "stripe_secret_key")
